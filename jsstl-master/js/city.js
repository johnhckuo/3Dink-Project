(function($) {
    ...
    $.fn.citySelect = function(options) {
		...
		$.getJSON(options.cityJson, function(data){
			$(element).html('<select name="sel_'+element_tmp+'" id="sel_'+element_tmp+'"><option value="">未選擇</option></select><select id="selc_'+element_tmp+'"><option value="">未選擇</option></select>');
			city = data;
